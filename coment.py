import requests
user = input('Escribe el nombre del usuario: ')
url = f"https://www.habbo-happy.net/profile/{user}"
headers = {
...
for i in range(num_requests):
    data = {
        "comment": f"BotSpammer by Aforak{i}",  # Añade el contador al comentario para hacerlo único
        "publish": "Publicar"
    }
